    ...
    <div className="border-2 border-[#D9D9D9] rounded-xl p-3 mt-3">
      ...
      <div className="flex items-center">
        ...
        <div className="leading-3 flex flex-col justify-center ml-1 text-xs">
          <p>Drake</p>
          <p className="text-[#00000099]">2h</p>
        </div>
      ...
      <div className="flex text-[#00000099]">
        <div className="flex items-center">
          ...
          <p className="text-sm ml-1">92</p>
        </div>
        <div className="mx-1" />
        <div className="flex items-center">
          <span className="iconify" data-icon="fluent:heart-20-regular"></span>
          <p className="text-sm ml-1">189</p>
        </div>
      </div>
    </div>
  );
