    ...
    <IonPage>
      <IonHeader mode="ios">
        <div className="flex p-4 items-center relative font-figtree">
          <p className="absolute left-[50%] translate-x-[-50%] text-xl text-black">
            Discover
          </p>
          <img
      ...
      <IonContent fullscreen>
        <div className="p-4 w-full">
          ...
          {/* todo : add horizontal scrolling and verification icon */}
          <div className="grid grid-cols-3 gap-28">
            {artists.map((e, i) => (
              ...
              >
                ...
                <button className="w-16 rounded-full bg-black">join</button>
              </div>
            ))}
          </div>
